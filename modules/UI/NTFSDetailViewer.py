...
class NTFSDetailViewer(QWidget):
    ...
    def initUI(self, contents):
        ...
        self.table1.setFixedSize(300, 145)
        self.table1.verticalHeader().setVisible(False)
        self.table1.verticalHeader().setDefaultSectionSize(28)
        self.table1.verticalHeader().setMaximumSectionSize(28)
        ...
        self.table2.setFixedHeight(145)
        self.table2.verticalHeader().setVisible(False)
        self.table2.verticalHeader().setDefaultSectionSize(28)
        self.table2.verticalHeader().setMaximumSectionSize(28)
