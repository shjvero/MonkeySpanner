...
class NTFSDetailViewer(QWidget):
    ...
    def initUI(self, contents):
        ...
        self.table1.verticalHeader().setDefaultSectionSize(24)
        self.table1.verticalHeader().setMaximumSectionSize(24)
        ...
        self.table2.setFixedHeight(160)
        self.table2.verticalHeader().setVisible(False)
        self.table2.verticalHeader().setDefaultSectionSize(30)
        self.table2.verticalHeader().setMaximumSectionSize(30)
